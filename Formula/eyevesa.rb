class Eyevesa < Formula
  ...
  homepage "https://github.com/Hafizaljohari/eyeVesa"
  version "0.1.1"

  on_macos do
    on_arm do
      url "https://raw.githubusercontent.com/Hafizaljohari/eyeVesa/v0.1.1/cli/eyevesa-arm64"
      sha256 "REPLACE_WITH_REAL_SHA256_ARM64"
    end
    on_intel do
      url "https://raw.githubusercontent.com/Hafizaljohari/eyeVesa/v0.1.1/cli/eyevesa-amd64"
